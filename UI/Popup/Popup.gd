...
func setPopupText(header: String, content: Array):
	$PanelContainer/VBoxContainer/MarginContainer/HBoxContainer/Header.setRichTextLabel(header)
	for labelText in content:
		...
		#$PanelContainer/VBoxContainer.add_child(richTextLabelExtended)
		#richTextLabelExtended.setRichTextLabel(label)
		var label = Label.new()
		$PanelContainer/VBoxContainer/MarginContainer2/ScrollContainer/VBoxContainer.add_child(label)
...
func setPopupImage(path: String):
	...
	$PanelContainer/VBoxContainer/MarginContainer2/ScrollContainer/VBoxContainer.add_child(node)
