var data = {
	...
	"shots": [
		...
		{"object": "dialog", "data": {"actor": "Gwyneth Remington", "text": "They're of our backs, for now."}},
		{"object": "dialog", "data": {"actor": "Aiyana", "text": "We still gotta stop the train!"}},
		{"object": "dialog", "data": {"actor": "Manuel Cárdenas", "text": "Our <i>cálido amigo</i>, Morrison, could have blown up <i>las ruedas del tren</i> easy!"}},
		{"object": "dialog", "data": {"actor": "Manuel Cárdenas", "text": "But no <i>amigos</i>, no <i>grandes explosivos!</i>"}},
		{"object": "dialog", "data": {"actor": "Manuel Cárdenas", "text": "We make only enemies, no friends!"}},
		...
		{"object": "dialog", "data": {"actor": "Manuel Cárdenas", "text": "Big lies! As usual!"}},
		{"object": "dialog", "data": {"actor": "Manuel Cárdenas", "text": "My <i>amigo</i>, <i>Compañero alegre</i>, sweet frowny-face! Lost to Pistoleros, for all time!"}},
		{"object": "dialog", "data": {"actor": "Manuel Cárdenas", "text": "<i>Mi villano</i>, Walker, you treat Morrison worse than dirt!"}},
		{"object": "dialog", "data": {"actor": "Manuel Cárdenas", "text": "I see you have no respect for any Pistolero. Not good for morale!"}},
