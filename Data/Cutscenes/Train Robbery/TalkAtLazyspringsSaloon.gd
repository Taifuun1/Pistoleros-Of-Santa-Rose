var data = {
	...
	"actors": [
		...
		{"name": "Manuel", "type": "Named People", "position": Vector2i(60, 0)},
		{"name": "Wells", "type": "Named People", "position": Vector2i(80, 0)}
	],
	"shots": [
		{"object": "camera", "data": {"position": Vector2i(0, 0)}},
		{"object": "dialog", "data": {"actor": "Gwyneth", "text": "OK, gang. Here's the plan."}},
		{"object": "action", "data": {"description": "Gwyneth puts down a map on the table"}},
		{"object": "dialog", "data": {"actor": "Gwyneth", "text": "We're going to go right here, near Berry Ridge Farms. From there, we'll see the train coming."}},
		{"object": "dialog", "data": {"actor": "Gwyneth", "text": "We have to stop the train. So, we're going to jump on the train from our horses."}},
		{"object": "dialog", "data": {"actor": "Aiyana", "text": "What about the Feds?"}},
		{"object": "dialog", "data": {"actor": "Gwyneth", "text": "I'm going with the assumption that there are only Feds in the train itself."}},
		{"object": "dialog", "data": {"actor": "Gwyneth", "text": "If there's Feds on horses following the train, we'll have to ride ahead of the train and blow up the tracks to stop it."}},
		{"object": "dialog", "data": {"actor": "Manuel", "text": "Our <i>explosivos</i> expert is not so young. He can't ride as fast as the train!"}},
		{"object": "dialog", "data": {"actor": "Gwyneth", "text": "I know. Let's ask Wells if he can keep up once he arrives here."}},
		...
		{"object": "dialog", "data": {"actor": "Gwyneth", "text": "Hey there, Wells. I think we got our plans figured out."}},
		{"object": "dialog", "data": {"actor": "Gwyneth", "text": "There's just one thing. How good is your horse riding?"}},
		...
		{"object": "dialog", "data": {"actor": "Gwyneth", "text": "OK, that's fine. Just so we know what to expect. We don't expect you to do any heavy lifting in the robbery."}},
		{"object": "dialog", "data": {"actor": "Gwyneth", "text": "It's time, gang. Let's move out, and make the greatest robbery in the West happen!"}}
	]
}
