var data = {
	...
	"shots": [
		...
		{"object": "dialog", "data": {"actor": "Aiyana", "text": "..."}},
		{"object": "dialog", "data": {"actor": "Aiyana", "text": "You fucking common thug! Put your actions where your mouth is! You're gonna lead us all the way to the front!"}},
		{"object": "dialog", "data": {"actor": "Aiyana", "text": "No more bullshit from you! If you want it, then go get the valuables!"}},
		{"object": "dialog", "data": {"actor": "Walker Langley", "text": "That..."}},
		{"object": "dialog", "data": {"actor": "Aiyana", "text": "Move it or I'll shoot you!"}},
