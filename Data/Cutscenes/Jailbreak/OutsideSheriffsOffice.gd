var data = {
	...
	"shots": [
		...
		{"object": "dialog", "data": {"actor": "Walker Langley", "text": "Ain't that right. We got to get to the Bandidos hideout now, so stock up. It should be a days travel down south, into the hills."}}
	]
}
