var data = {
	...
	"shots": [
		{"object": "dialog", "data": {"actor": "Walker Langley", "text": "The fuck is that noise?"}},
		...
		{"object": "dialog", "data": {"actor": "Manuel Cárdenas", "text": "The Bandidos of El Sacramento! <i>¡Feo!</i>"}},
		...
		{"object": "dialog", "data": {"actor": "Walker Langley", "text": "The hell you will! I ain't some yesterdays finch! We worked hard for this money!"}},
