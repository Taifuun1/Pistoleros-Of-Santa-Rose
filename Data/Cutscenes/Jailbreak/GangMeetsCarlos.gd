var data = {
	...
	"shots": [
		{"object": "dialog", "data": {"actor": "Walker", "text": "Come out, sombrero dent! You got our money, and we got your lead!"}},
		{"object": "dialog", "data": {"actor": "Carlos", "text": "Ooooh, it's the <i>Pistoleros del Diablo</i>! We meet again!"}},
		{"object": "dialog", "data": {"actor": "Manuel", "text": "If you don't give our money back, we'll show you we're worse than <i>el diablo</i> himself!"}},
		{"object": "dialog", "data": {"actor": "Carlos", "text": "Big words, big-big <i>tontos</i>! Time to find <i>dios</i>, Pistoleros!"}},
		{"object": "dialog", "data": {"actor": "Walker", "text": "We'll settle this right here."}},
