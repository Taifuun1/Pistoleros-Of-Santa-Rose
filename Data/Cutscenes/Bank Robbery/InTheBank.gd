...
var data = {
	...
	"shots": [
		{"object": "dialog", "data": {"actor": "Walker Langley", "text": "This is a robbery! Put your hands up!"}},
		{"object": "dialog", "data": {"actor": "Bank Assistant", "text": "Don't shoot!"}},
		{"object": "dialog", "data": {"actor": "Walker Langley", "text": "Keep your hands where I can see them!"}},
		{"object": "dialog", "data": {"actor": "Aiyana", "text": "Let's get cracking! Morrison! Bring the dynamite!"}},
		{"object": "dialog", "data": {"actor": "Morrison Branson", "text": "...I'm coming..."}},
		{"object": "dialog", "data": {"actor": "Bank Assistant", "text": "Please don't hurt us!"}},
		{"object": "dialog", "data": {"actor": "Walker Langley", "text": "Quiet! We don't want no ruckus!"}},
		{"object": "dialog", "data": {"actor": "Gwyneth Remington", "text": "The dynamite is in place. Let's blast 'em."}},
		...
		{"object": "dialog", "data": {"actor": "Walker Langley", "text": "Look at that..."}},
		{"object": "dialog", "data": {"actor": "Manuel Cárdenas", "text": "<i>Riqueza</i> like sand in the desert!"}},
		{"object": "dialog", "data": {"actor": "Aiyana", "text": "Yes! There's money here for days!"}},
		{"object": "dialog", "data": {"actor": "Walker Langley", "text": "Get it all on the horses. Step on it! And tie it on properly this time!"}}
	]
}
